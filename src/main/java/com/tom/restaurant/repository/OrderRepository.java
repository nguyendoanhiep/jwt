...
public interface OrderRepository extends JpaRepository<Orders,Long> {
    @Query("select new com.tom.restaurant.entity.dto.OrdersDto(o.id,c.name,o.code,o.numberPhone,v.name,o.originalTotalValue,o.discountAmount,o.totalValue,o.status,o.createDate) " +
